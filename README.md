...
**AI-powered study assistant — upload a PDF, get instant summaries, flashcards, MCQs, formula sheets, and more.**

![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat&logo=html5&logoColor=white)
![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat&logo=css3&logoColor=white)
![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black)
![Dify](https://img.shields.io/badge/Powered%20by-Dify-6366F1?style=flat)
...
- 🧠 **Flashcards** — auto-generates 10 Q&A revision cards
- ❓ **MCQ Generator** — creates 10 multiple-choice practice questions
...
├── style.css        # Styling (glassmorphism UI, responsive, dark mode)
├── config.js         # Your Dify API key + app settings
├── script.js       # PDF parsing, Dify calls, all AI features
└── README.md
```
